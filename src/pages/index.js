...
export default () => (
  <Layout>
    ...
    <p>
      I've used Nivo (D3js) and MySQL to{" "}
      <a href="https://www.sauti-databank.com/">visualize data</a> for a
      nonprofit, built Dolly Parton-inspired{" "}
      <a href="https://twitter.com/kimeejohnson/status/1179889420142436354">
        demos
      </a>{" "}
      to learn React, and used serverless tools to celebrate{" "}
      <a href="https://dev.to/kimberleejohnson/trying-to-make-fetch-errr-a-post-request-happen-12ad">
        Mean Girls Day
      </a>
      . More in my <a href="https://kimberlee.dev/portfolio">portfolio</a>!
    </p>
