...
export default () => (
    ...
    <div>
        ...
        /> 
        <p>A data visualization project for Sauti.org, an NGO that manages an SMS platform that East African border traders use to look up realtime market data. We converted data collected from SMS queries into a readable, then visual format. </p>
